...
![Настройки](https://github.com/Anatoliy030501/Keyboard-Trainer/blob/main/Mockups/Settings.png) <br/>

При нажатии на кнопку "Начать" в зависимости от выбранного вида тренировки пользователь перейдет к окнам игры:

![Игра1](https://github.com/Anatoliy030501/Keyboard-Trainer/blob/main/Mockups/StartTrainingForLearning.png) <br/>

![Игра2](https://github.com/Anatoliy030501/Keyboard-Trainer/blob/main/Mockups/StartTrainingForSpeed.png) <br/>
...
#### 3.2.2. Ограничения<a name="3.2.2"></a>
  ...
  1. Операционная система Windows7 и младше;
  2. Наличие Java 8.
