...
public class SpeedTrainingController {
    ...
    public void showReference(ActionEvent event) throws IOException {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\37533\\Desktop\\Keyboard-trainer\\klavatrainer\\src\\reference.txt"), "UTF-8"));
        String currentLine;
    ...
    public void setText() throws IOException {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\37533\\Desktop\\Keyboard-trainer\\klavatrainer\\src\\" + fileName + ".txt"), "UTF-8"));
        String currentLine;
        textArea.setText("");
        while((currentLine = bufferedReader.readLine()) != null)
        {
